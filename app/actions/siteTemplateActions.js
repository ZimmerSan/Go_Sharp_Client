...
export const loadSiteTemplates = (siteTemplates) => (store.dispatch({ type: SITE_TEMPLATE_LOAD, siteTemplates }));
export const addSiteTemplate = (siteTemplate) => (store.dispatch({ type: SITE_TEMPLATE_ADD, siteTemplate }));
